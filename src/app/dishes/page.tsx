import { getDishes, getAvailableUnits } from "@/app/actions/dishes"
...
export default async function DishesPage() {
  ...
  const { data: units } = await getAvailableUnits()

  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold tracking-tight">Gerichte</h1>
        <DishCreateButton availableIngredients={ingredients || []} availableUnits={units || []} />
      </div>
